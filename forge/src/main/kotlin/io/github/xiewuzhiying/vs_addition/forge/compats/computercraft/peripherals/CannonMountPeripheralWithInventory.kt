...
class CannonMountPeripheralWithInventory(peripheralType: String, tileEntity: CannonMountBlockEntity, val inventory: IItemHandler) : CannonMountPeripheral(peripheralType,
    tileEntity
){
