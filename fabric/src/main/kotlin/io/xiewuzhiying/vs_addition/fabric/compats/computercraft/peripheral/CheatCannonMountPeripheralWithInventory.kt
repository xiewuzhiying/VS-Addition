...
class CheatCannonMountPeripheralWithInventory(peripheralType: String, tileEntity: CannonMountBlockEntity, val inventory: StorageWrapper) : CheatCannonMountPeripheral(peripheralType,
    tileEntity
){
